...
namespace App\Http\Controllers\MoneyIn;
...
class SaleController extends Controller
{
    public function index()
    {
        ...
        return view('sale.index', compact('purchases'));
    }
    ...
    {
        $branches           = Branch::all();
        $delivery_persons   = Contact::whereIn('category_id', [3, 5])->get();
        $customers          = Contact::where('category_id', 1)->get();
        $items              = Item::all();
        $payment_accounts   = Account::whereIn('account_type_id', [4, 5])->get();
        return view('sale.create', compact('branches', 'delivery_persons', 'customers', 'items', 'payment_accounts'));
    }
    ...
    public function edit($id)
    {
        ...
        $items              = Item::all();
        $payment_accounts   = Account::whereIn('account_type_id', [4, 5])->get();
        return view('sale.edit', compact('branches', 'delivery_persons', 'vendors', 'items', 'payment_accounts', 'purchase', 'purchase_entries'));
    }
