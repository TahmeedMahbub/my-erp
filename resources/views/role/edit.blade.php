                    ...
                    <div class="card-body">
                        <form action="{{ route('roles_update') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-sm-3 col-form-label text-end">Manager Role</label>
                                        <div class="col-sm-9">
                                            <select name="manager_role" class="form-select">
                                                <option value="">Select Manager Role</option>
                                                @foreach ($roles as $m_role)
                                                    <option value="{{ $m_role->id }}" {{ $m_role->id == $role->manager_role ? 'selected' : '' }}>{{ $m_role->role_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-10">
                                    <div class="mb-3 row">
                                        <label for="example-url-input" class="col-sm-2 col-form-label text-end">Role Details</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="role_details" placeholder="Enter Role Details (Required)" value="{{ $role->details }}" id="example-url-input">
                                        </div>
                                    </div>
                                </div>
