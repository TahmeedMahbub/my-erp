    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Edit User Branch</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-4 row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="branch_name" value="{{ $branch->name }}" placeholder="Enter Branch Name (Required)" id="example-text-input" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" name="branch_location" value="{{ $branch->location }}" placeholder="Enter Branch Location" id="example-text-input" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="branch_details" value="{{ $branch->details }}" placeholder="Enter Branch Details" id="example-url-input" required>
                                        </div>
                                    </div>
                                </div>
