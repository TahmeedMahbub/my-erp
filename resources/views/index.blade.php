                ...
                <div class="card-body">
                    <div class="table-responsive browser_users">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="{{asset('assets/images/logos/chrome.png')}}" alt="" height="20" class="me-2">Chrome</td>
                                    <td>10853<small class="text-muted">(52%)</small></td>
                                    <td> 52.80%</td>
                                    <td>566<small class="text-muted">(92%)</small></td>
                                </tr><!--end tr-->
                                <tr>
                                    <td><img src="{{asset('assets/images/logos/micro-edge.png')}}" alt="" height="20" class="me-2">Microsoft Edge</td>
                                ...
                                <tr>
                                    <td><img src="{{asset('assets/images/logos/opera.png')}}" alt="" height="20" class="me-2">Opera</td>
