    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-end">
                    <a href="{{route('product_category')}}" class="btn btn-de-primary btn-sm"><i class="mdi mdi-view-list"></i> All Contact Categories</a>
                </div>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="card-body">
                        <form action="{{ route('product_category_update') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="mb-3 row">
