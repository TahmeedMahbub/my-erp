                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" type="text" value="{{ $contact->code }}" placeholder="Enter Unique Contact Code" name="code">
            ...
            {{-- <div class="row">
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('firstname') ? 'has-error' : '' }}">
                        ...
                        <input type="text" id="firstname" name="firstname" class="form-control" placeholder="Enter First Name" value="{{ $contact->firstname }}">
